...
static inline lr_window* window_start() {
    if (!glfwInit()) {
        printf("FAILED TO INITIALISE GLFW\n");
        return NULL;
    }

    lr_window* example = lr_window_create(640, 480, "Test");
...
int main(int argc, char* argv[]) {
    ...
    lr_mesh   triangle = lr_mesh_create(verts, 3, indices, 3);
